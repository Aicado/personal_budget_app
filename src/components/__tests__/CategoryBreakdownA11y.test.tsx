...
describe('CategoryBreakdown Accessibility', () => {
  ...
  it('has correct ARIA attributes for progress bars', () => {
    ...
    const foodBar = screen.getByLabelText(/Food spending/)
    ...
    expect(foodBar).toHaveAttribute('aria-valuetext', '$500.00')

    const rentBar = screen.getByLabelText(/Rent spending/)
    ...
    expect(rentBar).toHaveAttribute('aria-valuetext', '$1500.00')
  })
})
