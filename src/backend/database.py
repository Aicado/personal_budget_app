    ...
    def insert_transactions(self, df: pl.DataFrame, filename: str, account_name: str = None, account_type: str = None, account_path: str = None, categorizer=None) -> Dict[str, Any]:
        ...
        if categorizer:
            ...
            if not needs_llm_df.is_empty():
                ...
                # Parallelize LLM categorization calls using asyncio.gather
                # This significantly reduces ingestion latency by executing independent API calls concurrently.
                import nest_asyncio
                nest_asyncio.apply()
                ...
                async def get_all_categorizations():
                    tasks = [
                ...
                results = loop.run_until_complete(get_all_categorizations())

                llm_mappings = {}
                for row, llm_result in zip(unique_uncat_payees, results):
                    payee = row["payee"]
                    ...
                    if llm_result:
                        ...
                        # Save mapping for future performance/consistency
